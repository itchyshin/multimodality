...
#main$mod_table$name <- "All" 

# need to check the sample sizes are plotted accurately
#main$data$moderator <- rep("All", 640)
...
text(11, 14, expression(italic(k) == 640 (116)), cex = 0.9)
fun <- recordPlot()
invisible(dev.off())	   
