...
### Processed data and missing data

```{r}
# showing dataset table
...
vcv_tree_50 <- map(tree_50, vcv)

# running 50 meta-analyses with 50 different trees
ma_50 <- map(vcv_tree_50, model_run)

# TODO we probably need to save 
