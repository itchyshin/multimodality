...
ldf <- lapply(ldf, function(x) image_negate(image_read(x)))
...
phy_fig5 <- ggdraw(phy_fig4) +
  ...
  draw_image(ldf$Columbiformes.png, y = 0.3, x = -0.35, scale = 0.05) +
  draw_image(ldf$Piciformes.png, y = 0.25, x = -0.45,scale = 0.05) +
  draw_image(ldf$Procellariiformes.png, y = 0.25, x = -0.4, scale = 0.05) +
...
phy_fig5 / map_fig +  plot_annotation(tag_levels = 'A') + plot_layout(heights = c(2.5,1.))
